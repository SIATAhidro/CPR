...
class SqlDb:
    ...
    def __init__(self,dbname,user,table,host,passwd,port,codigo=None,*keys,**kwargs):
        '''
    ...
    def df_to_sql(self,df,chunksize=20000,*keys,**kwargs):
        ...
        chunksize = If not None, then rows will be written in batches of this size at a time
        '''
